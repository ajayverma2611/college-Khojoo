  ...
  return (
    ...
    <div className="InstructionPage">
      ...
      <div className="InstructionContent">
        ...
        >
          Welcome to the JEE Mains Mock Test! Follow the instructions carefully
          to ensure you have a smooth experience while taking the test.
        </p>
        <p
          className="textFormatting"
        ...
        <p>
          <span className="textFormatting">Total Duration:</span> 3 Hours
        </p>
        <p>
          <span className="textFormatting">Total Number of Questions:</span> 75{" "}
          (25 Questions each from Physics, Chemistry, and Mathematics)
        </p>
        <p>
          <span className="textFormatting">Type of Questions:</span> Multiple
          Choice Questions (MCQs) and Numerical Type Questions
        </p>
        <p>
          <span className="textFormatting">Total Marks:</span> 300 (4 Marks for
          each correct answer, -1 Mark for each wrong answer in MCQs)
        </p>
        <p
          className="textFormatting"
          style={{ textAlign: "center", marginTop: "10px", fontSize: "20px" }}
