    ...
    <div className="testPage">
      ...
      <div className="test-container">
        ...
        <div className="test-header2">
          <button className={"herobutton" + (subIndex !== 2 ? " test-disabled" : "")} id="test-nav-btn" onClick={(e) => {dispatch(setSubindex({subIndex: 2})); dispatch(setQuestionindex({questionIndex: 0})); window.location.reload()}}>Maths</button>
          <button className={"herobutton" + (subIndex !== 0 ? " test-disabled" : "")} id="test-nav-btn" onClick={(e) => {dispatch(setSubindex({subIndex:0})); dispatch(setQuestionindex({questionIndex: 0})); window.location.reload();}}>Physics</button>
          <button className={"herobutton" + (subIndex !== 1 ? " test-disabled" : "")} id="test-nav-btn" onClick={(e) => {dispatch(setSubindex({subIndex:1})); dispatch(setQuestionindex({questionIndex: 0})); window.location.reload();}}>Chemistry</button>
        </div>
