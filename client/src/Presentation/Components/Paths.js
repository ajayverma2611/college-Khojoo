...
const Paths = () => {
  const paths = [
    ...
    },
    {
      ...
      "duration": "3 hours",
      "months": ["May"],
      "description": "The Telangana State Engineering, Agriculture and Medical Common Entrance Test (TSMSET) is a state-level entrance exam conducted by the Telangana State Council of Higher Education (TSCHE). It is held annually for admission to undergraduate programs in engineering, agriculture, and medical fields across various institutions in Telangana. The TSMSET exam is specifically designed for students seeking admission to B.Tech, B.Pharmacy, B.Sc Agriculture, and B.V.Sc courses, among others, in government and private colleges within the state. The exam is a multiple-choice question (MCQ)-based test, and it covers subjects like Physics, Chemistry, Mathematics, and Biology depending on the stream chosen by the candidate. Students applying for engineering courses typically need to take the Physics, Chemistry, and Mathematics sections, while those applying for medical and agricultural courses need to focus on Physics, Chemistry, and Biology. TSMSET is recognized for its structured syllabus, which is based on the NCERT curriculum for classes 11 and 12. The test is typically held in May and lasts for 3 hours. It is a crucial exam for students aiming for quality education in the state's top engineering and medical colleges. Students who perform well in TSMSET can secure admission to popular institutions like JNTU Hyderabad, Osmania University, and other affiliated colleges. The exam follows a well-defined marking scheme: correct answers earn a fixed number of marks, and incorrect answers incur a penalty. The marks for each correct answer are typically 1, with no negative marking for wrong answers. The exam is highly competitive, and candidates generally prepare for about 6 to 12 months to cover the extensive syllabus and enhance their problem-solving skills. The TSMSET is an important gateway for students who wish to pursue higher education in the fields of engineering, agriculture, and medical sciences within the state of Telangana.",
      "subjects": [
    ...
    },
    {
      ...
      "duration": "2 hours",
      "months": ["May"],
      "description": "The Law Common Entrance Test (LAWSET) is an entrance exam conducted by Osmania University on behalf of the Telangana State Council of Higher Education (TSCHE) for admission to 5-year integrated LLB (Bachelor of Laws) programs in various law colleges across Telangana. The exam is designed for students who have completed their higher secondary education (12th grade) and aspire to pursue a career in law. LAWSET is held annually, typically in May, and is considered a gateway for aspiring law students to enter prestigious law colleges in the state. The exam assesses the candidate's aptitude in subjects that are critical for law studies, including General Knowledge, English Language, Legal Aptitude, and Logical Reasoning. It consists of multiple-choice questions (MCQs) with a total duration of 2 hours. The LAWSET syllabus is designed to test the candidate's awareness of legal principles, logical thinking, and verbal ability. The exam helps determine the candidate's readiness for law school, and it is a crucial step for those aiming for a legal career. The LAWSET exam is highly competitive, with thousands of students vying for a limited number of seats in law schools. The marks for each correct answer are awarded based on a predefined scale, and there is no negative marking for incorrect responses. LAWSET serves as an excellent opportunity for students to pursue a career in law in the state of Telangana, and candidates generally prepare for about 6 to 9 months, focusing on improving their general awareness, reasoning skills, and understanding of legal concepts.",
      "subjects": [
        {
